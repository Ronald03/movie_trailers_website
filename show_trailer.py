##mport  media class and fresh_tomatoes
import media
import fresh_tomatoes

#Instanciate the media class to create new movies,
#Must provide a movie name, storyline, images of movie's poster and a video link (youtube) for the trailer
...
bucket_list = media.Movie("The Bucket List",
                             "Two men, blue-collar mechanic Carter Chambers and billionaire hospital magnate Edward Cole meet for the first time in the hospital after both have been diagnosed with terminal lung cancer.",
...
going_in_style = media.Movie("Going In Style",
...
last_vegas = media.Movie("Last Vegas",
...
#Call fresh_tomates class to load and open a html page with all the movies on the movies array
